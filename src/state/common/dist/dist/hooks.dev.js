  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 2:
          balance = _a.apply(void 0, [_b.sent(), 18]) //   console.log(balance,'balance##')

          if (assetBaseInfoObj[asset]) {
          ...
          return [
            4,
            /*yield*/
            contract.allowance(account, index_1.mintAddress),
          ]
        ...
        case 3:
          ...
          console.log(assetBaseInfoObj, 'assetBaseInfoObj##########')
          console.log(assetBaseInfoArr, 'assetBaseInfoArr##########')
          dispatch(
            actions_1.upDateAssetBaseInfoObj({
              assetBaseInfoObj: assetBaseInfoObj,
            }),
          )
          _b.label = 4
