...
var ProfileList = function (props) {
    var _a = react_1.useState('Positions'), headerActive = _a[0], setHeaderActive = _a[1];
    ...
    return (React.createElement("div", { className: "table-content" },
        React.createElement("ul", { className: "table-header-tab" }, tablieNav.map(function (ele, key) { return (React.createElement("li", { className: ['header-tab-item', ele.label === headerActive ? 'header-tab-item-active' : null].join(' '), key: key, onClick: function () { return setHeaderActive(ele.label); } },
            React.createElement("svg", { className: "icon", "aria-hidden": "true", fill: ele.label === headerActive ? '#005AFF' : '#1C1C1C' },
