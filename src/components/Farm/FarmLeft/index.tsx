...
import '../../../style/Farm/farmLeft.less'
import useChart from '../../../hooks/useChart'
import TipsImg from '../../../img/common/tips@2x.png'
import tencent from '../../../img/coin/tencent.png'
import useModal from '../../../hooks/useModal'
import TikerInfo from '../../Mint/SymbolChart/tikerInfo'
import AssetPair from '../../Mint/SymbolChart/chooseAssetPair'
...
const FarmLeft: React.FC<SymoblChartProps> = props => {
  const mintState = useMintState()
  const [openTikerInfo] = useModal(<TikerInfo></TikerInfo>)
  ...
  return (
    <div className="farmLeft-container">
      <div className="title">
