  ...
  return (
    <div className="long-container">
      <div className="short-desc">
        Provide liquidity to receive LP tokens which are staked to earn NSDX token rewards. nAssets can be
        <NavLink to={`/trade`} activeClassName="active"><span className="link"> Purchased </span></NavLink>
        {/* <span className="link"> Purchased </span> */}
        <svg className="icon" aria-hidden="true">
          <use xlinkHref="#arrow"></use>
        </svg>or
        <NavLink to={`/mint`} activeClassName="active"><span className="link"> Mint </span></NavLink>
        {/* <span className="link"> Mint</span> */}
        <svg className="icon" aria-hidden="true">
          <use xlinkHref="#arrow"></use>
        </svg>
      </div>
      <div className={amountActive ? 'amount-active amount' : 'amount'}>
        <div className="amount-header">
          <p className="amount-text">Input</p>
          <p className="balance">
            Balance 0.0
      ...
      <Button className="long-farm" onClick={openConfirmOrder}>Farm</Button>
