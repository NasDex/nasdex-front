...
const ShortOrderConfirm = ({
  ...
  return (
    <Modal title="Short Farm" width={420} footer={null} visible={true} onOk={onDismiss} onCancel={onDismiss}>
      <div className="short-order-confirm-conntent">
        ...
        <div className="detail">
          ...
          <div className="detail-item">
            <div className="leabl">Returned</div>
            <div className="text">1.15 USDC</div>
          </div>
        </div>
