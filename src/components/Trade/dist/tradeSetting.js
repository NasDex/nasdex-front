...
var TradeSetting = function (_a) {
  ...
  return React.createElement(
    antd_1.Modal,
    {title: 'Setting', width: 376, footer: null, visible: true, onOk: onDismiss, onCancel: onDismiss},
    React.createElement(
      'div',
      {className: 'trade-setting'},
      React.createElement(
        'div',
        ...
        React.createElement(
          ...
          slippageArr.map(function (ele, key) {
            return React.createElement(
              'div',
              {
