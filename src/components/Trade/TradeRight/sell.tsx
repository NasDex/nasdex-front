...
import ConfirmOrder from '../sellOrderConfirm/index'
    ...
    <div className="sell-container">
      ...
      <div className={amountActive ? 'amount-active amount' : 'amount'}>
        <div className="amount-header">
          <p className="amount-text">Sell</p>
          <p className="balance">
            Balance 0.0
      ...
      <Button className="Confirm" onClick={openConfirmOrder}>Confirm Order</Button>
