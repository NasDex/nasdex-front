...
var LPPool = function (props) {
    var LpPoolListArray = props.LpPoolListArray, setLpTotalPrice = props.setLpTotalPrice;
    return (react_1["default"].createElement("div", null, LpPoolListArray.map(function (ele, key) { return (react_1["default"].createElement(LpPoolItem, { key: key, setLpTotalPrice: setLpTotalPrice, lpPoolItem: ele })); })));
};
var LpPoolItem = function (props) {
    ...
    var _c = react_1.useState(false), isApproved = _c[0], setIsApproved = _c[1];
    var _d = react_1.useState('0'), totalLiquidity = _d[0], setTotalLiquidity = _d[1];
    var _e = react_1.useState(''), harvestBalance = _e[0], setHarvestBalance = _e[1];
    var _f = react_1.useState(0), accountLpPrice = _f[0], setAccountLpPrice = _f[1];
    var stakeState = hooks_2.useStakeState();
    var priceList = stakeState.priceList;
    var lpPoolItem = props.lpPoolItem, setLpTotalPrice = props.setLpTotalPrice;
    ...
    var _g = useAuth_1["default"](), login = _g.login, logout = _g.logout;
    ...
    function getAllowance() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, LPContract.allowance(account, index_1.MasterChefAddress)];
                    case 1:
                        result = _a.sent();
    ...
    // 设置Apr
    var _l = react_1.useState(''), apr = _l[0], setApr = _l[1];
    var openCalculatorCard = useModal_1["default"](react_1["default"].createElement(deaufltCalculator_1["default"], { apr: apr }))[0];
    var _m = react_1.useState([]), reserves = _m[0], setReserves = _m[1];
    var _o = react_1.useState(0), totalSupply = _o[0], setTotalSupply = _o[1];
    ...
    var _p = react_1.useState('0'), totalSupplyPrice = _p[0], setTotalSupplyPrice = _p[1];
    react_1.useEffect(function () {
        function calculateApr() {
            return __awaiter(this, void 0, void 0, function () {
                var aprP, tvlF, price, day, currencyANum, currencyBNum, num, accountNum, result;
                return __generator(this, function (_a) {
                    aprP = 0;
                    tvlF = totalLiquidity;
                    ...
                    if (reserves && reserves[0]) {
                        currencyANum = Number(utils_1.formatUnits(reserves[0], lpPoolItem.decimals)) * priceList[lpPoolItem.currencyA];
                    }
                    if (reserves && reserves[1]) {
                        currencyBNum = Number(utils_1.formatUnits(reserves[1], lpPoolItem.decimals)) * priceList[lpPoolItem.currencyB];
                    }
                    num = (Number(tvlF) / Number(totalSupply)) * Number(currencyANum + currencyBNum);
                    accountNum = (Number(amount) / Number(totalSupply)) * Number(currencyANum + currencyBNum);
    ...
    var openStakeCard = useModal_1["default"](react_1["default"].createElement(stake_1["default"], { poolInfo: __assign(__assign({}, lpPoolItem), { balance: balance, poolType: 'PreIDO' }) }))[0];
    var openUntakeCard = useModal_1["default"](react_1["default"].createElement(unstake_1["default"], { poolInfo: __assign(__assign({}, lpPoolItem), { amount: amount }) }))[0];
    var openClaimCard = useModal_1["default"](react_1["default"].createElement(claimAll_1["default"], { poolInfo: __assign(__assign({}, lpPoolItem), { harvestBalance: harvestBalance }) }))[0];
    return (react_1["default"].createElement("div", { className: "liquidity-item liquidity-item-lp" },
        react_1["default"].createElement("div", { className: "liquidity-header" },
            ...
            react_1["default"].createElement("div", { className: "liquidity-source" },
                react_1["default"].createElement("a", { href: "https://quickswap.exchange/#/add/0x3813e82e6f7098b9583FC0F33a962D02018B6803/0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174", target: "_blank" },
                    "From",
        ...
        react_1["default"].createElement("div", { className: "liquidity-bottom" },
            ...
            react_1["default"].createElement("div", { className: "apr" },
                react_1["default"].createElement("div", { className: "title" },
                    ...
                    react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true", onClick: openCalculatorCard },
        ...
        Number(harvestBalance) > 0 ? (Number(amount) > 0 ? (react_1["default"].createElement("span", { className: "line" })) : null) : Number(amount) > 0 ? (react_1["default"].createElement("span", { className: "line" })) : null,
        react_1["default"].createElement("div", { className: "claim-unstake" },
            Number(harvestBalance) > 0 ? (react_1["default"].createElement("div", { className: "claim" },
                ...
                !account ? (react_1["default"].createElement(antd_1.Button, { className: "pc-stake-btn", onClick: function () { return onPresentConnectModal(); } }, "Connect")) : (react_1["default"].createElement(antd_1.Button, { onClick: function () { return openClaimCard(); } }, "Claim")))) : null,
            Number(amount) > 0 ? (react_1["default"].createElement("div", { className: "claim" },
                react_1["default"].createElement("div", { className: "left" },
                    ...
                    react_1["default"].createElement("p", null,
                        "\u2248$",
                        utils_2.fixD(accountLpPrice, 4))),
                !account ? (react_1["default"].createElement(antd_1.Button, { className: "pc-stake-btn", onClick: function () { return onPresentConnectModal(); } }, "Connect")) : !isApproved ? (react_1["default"].createElement(antd_1.Button, { className: "pc-stake-btn", onClick: openUntakeCard }, "Unstake")) : (react_1["default"].createElement(antd_1.Button, { className: "pc-stake-btn", onClick: function () { return handleApprove(); }, loading: requestedApproval }, "Approve")))) : null)));
};
