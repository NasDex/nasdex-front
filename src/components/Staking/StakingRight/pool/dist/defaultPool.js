...
var DefaultPool = function (props) {
    ...
    return (react_1["default"].createElement("div", null, DefaultPoolListArray.map(function (ele, key) { return (react_1["default"].createElement(DefaultPoolItem, { defaultPoolItem: ele, key: key })); })));
};
var DefaultPoolItem = function (props) {
    ...
    var _e = react_1.useState(''), pendingNsdx = _e[0], setpendingNsdx = _e[1];
    var _f = react_1.useState(''), harvestBalance = _f[0], setHarvestBalance = _f[1];
    ...
    function getAllowance() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, NSDXContract.allowance(account, index_1.MasterChefAddress)];
                    case 1:
                        result = _a.sent();
    ...
    var openStakeCard = useModal_1["default"](react_1["default"].createElement(stake_1["default"], { poolInfo: __assign(__assign({}, defaultPoolItem), { balance: balance, poolType: 'PreIDO' }) }))[0];
    var openUntakeCard = useModal_1["default"](react_1["default"].createElement(unstake_1["default"], { poolInfo: __assign(__assign({}, defaultPoolItem), { amount: amount }) }))[0];
    var openClaimCard = useModal_1["default"](react_1["default"].createElement(claimAll_1["default"], { poolInfo: __assign(__assign({}, defaultPoolItem), { harvestBalance: harvestBalance }) }))[0];
    return (react_1["default"].createElement("div", { className: "liquidity-item" },
        react_1["default"].createElement("div", { className: "liquidity-header" },
            react_1["default"].createElement("div", { className: "liquidity-logo" },
                react_1["default"].createElement("img", { src: logo_png_1["default"], alt: "", className: "liquidity-naxlogo-img" }),
        ...
        react_1["default"].createElement("div", { className: "claim-unstake" },
            ...
            Number(amount) > 0 ? (react_1["default"].createElement("div", { className: "claim" },
                react_1["default"].createElement("div", { className: "left" },
                    ...
                    react_1["default"].createElement("p", null,
                        "\u2248$",
                        utils_2.fixD(Number(amount) * priceList.NSDX, 4))),
