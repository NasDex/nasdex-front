...
var useStakeFarms_1 = require('hooks/autoStake/useStakeFarms')
var useStakeFarms_2 = require('hooks/deaufltPool/useStakeFarms')
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4 /*yield*/, onMasterStake(amount)]
          case 1:
            _a.sent()
            return [3 /*break*/, 4]
          case 2:
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      poolInfo.poolType === 'Lpfarming'
        ? React.createElement(
            'div',
            {className: 'liquidity-source-stake'},
            React.createElement(
              'a',
      ...
      React.createElement(
        ...
        React.createElement('img', {
          src:
            poolInfo.poolType === 'vault'
              ? nas_png_1['default']
              : poolInfo.poolType === 'PreIDO'
              ? logo_png_1['default']
              : coin_2x_png_1['default'],
          alt: '',
          className:
