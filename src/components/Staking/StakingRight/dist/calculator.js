...
var TikerInfo = function (_a) {
  ...
  var d7 = (Math.pow(1 + Number(str), 7) - 1) * 100
  // 30d ROI=[ (1+APR/365)^30 ] -1
  var d30 = (Math.pow(1 + Number(str), 30) - 1) * 100
  // 365 ROI, 即APY= [ (1+APR/365)^365 ] -1
  var d365 = (Math.pow(1 + Number(str), 365) - 1) * 100
  function num(val) {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          {className: 'item'},
          React.createElement('p', {className: 'itemp'}, '365d(APY)'),
