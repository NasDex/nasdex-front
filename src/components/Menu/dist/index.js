...
var Menu = function (props) {
    ...
    var _a = react_1.useState(false), showListMenu = _a[0], setShowListMenu = _a[1];
    ...
    var _b = useAuth_1["default"](), login = _b.login, logout = _b.logout;
    var _c = WalletModal_1.useWalletModal(login, logout, account || undefined), onPresentConnectModal = _c.onPresentConnectModal, onPresentAccountModal = _c.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (react_1["default"].createElement("div", { className: "container" },
        react_1["default"].createElement("div", { className: "sidebar" },
            react_1["default"].createElement("div", { className: "h5-nav" },
                react_1["default"].createElement("img", { src: logo_2x_png_1["default"] }),
                react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true", onClick: function () {
                        setShowListMenu(!showListMenu);
                    } },
                    react_1["default"].createElement("use", { xlinkHref: "#icon-menu-open" }))),
            react_1["default"].createElement("div", { className: showListMenu ? 'menu-list-block show' : 'menu-list-block' },
                react_1["default"].createElement("div", { className: "logo" },
                    react_1["default"].createElement("img", { src: logo_2x_png_1["default"] }),
                    react_1["default"].createElement("span", { className: "toggle-btn" },
                        react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true" },
                            react_1["default"].createElement("use", { xlinkHref: "#icon-left" })))),
                !account ? (react_1["default"].createElement("div", { className: "wallet-btn connect-wallet-btn", onClick: function () { return onPresentConnectModal(); } },
                    react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true" },
                        react_1["default"].createElement("use", { xlinkHref: "#icon-Connect-Wallet" })),
                    react_1["default"].createElement("span", null, "Connect Wallet"))) : (react_1["default"].createElement("div", { className: "wallet-btn wallet-account", onClick: function () { return onPresentAccountModal(); } },
                    react_1["default"].createElement("div", { className: "network", onClick: openNetwork },
                        react_1["default"].createElement("i", null),
                        react_1["default"].createElement("span", null, "Polygon")),
                    react_1["default"].createElement("div", { className: "address", onClick: openAccountCard }, accountEllipsis))),
                react_1["default"].createElement("div", { className: "menu-container" },
                    react_1["default"].createElement("div", { className: "menu-list" },
                        react_1["default"].createElement(react_router_dom_1.NavLink, { to: "/mint", activeClassName: "active" },
                            react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true" },
                        ...
                        react_1["default"].createElement(react_router_dom_1.NavLink, { to: "/staking", activeClassName: "active" },
                            react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true" },
                                react_1["default"].createElement("use", { xlinkHref: "#Icon-Stake-Active" })),
                            react_1["default"].createElement("span", null, "Stake"))),
                    react_1["default"].createElement("div", { className: "menu-bottom" },
                        react_1["default"].createElement("a", { className: "docs", href: "https://nasdexofficial.gitbook.io/nasdex/", target: "_blank" }, "NASDEX Docs"),
                        react_1["default"].createElement("div", { className: "link-list" },
                            react_1["default"].createElement("a", { href: "https://twitter.com/nasdex_xyz", target: "_blank" },
                                react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true" },
                                    react_1["default"].createElement("use", { xlinkHref: "#icon_twitter" }))),
                            react_1["default"].createElement("a", { href: "https://t.me/nasdex_xyz", target: "_blank" },
                                react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true" },
                                    react_1["default"].createElement("use", { xlinkHref: "#icon_Telegram-Group" }))),
                            react_1["default"].createElement("a", { href: "https://medium.com/@nasdex", target: "_blank" },
                                react_1["default"].createElement("svg", { className: "icon", "aria-hidden": "true" },
