...
var useHarvestFarm = function (farmPid) {
  var MasterchefContract = useContract_1.useMasterchef()
  var handleHarvest = react_1.useCallback(
    function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              _a.trys.push([0, 2, , 3])
              return [4 /*yield*/, deaufltPoolStake_1.harvestFarm(MasterchefContract, farmPid)]
            case 1:
              txHash = _a.sent()
...
exports['default'] = useHarvestFarm
